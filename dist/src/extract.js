...
function extractCriterionResult(output) {
    ...
    try {
        ...
        console.log(err);
        throw new Error(`Output file for 'cargo-criterion' must be JSON file generated by --message-format=json option: ${err.message}`);
    }
    return ret;
}
